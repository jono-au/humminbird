...
function theme_enqueue_styles(){
	...
	wp_enqueue_style('child-style', get_stylesheet_directory_uri() . '/core/assets/css/humminbird-custom.css', $child_style, $resources_version);
}
...
function my_scripts_method() {
	wp_enqueue_script(
		'custom-script',
		get_stylesheet_directory_uri() . '/core/assets/js/humminbird-custom.js',
		array( 'jquery' )
	 );
	 wp_enqueue_script('custom-script2', get_stylesheet_directory_uri().'/core/assets/js/humminbird-custom2.js');
